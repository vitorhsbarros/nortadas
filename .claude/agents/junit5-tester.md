...
- **Don't test the framework or trivial getters** generated by Lombok — spend coverage on our
  logic. If a class is hard to reach 95% on, that usually signals a design smell worth flagging back
