 ...
 * {@code com.nortadas.domain.region.Region} (the beach's containing region)
 * across the aggregate boundary. Pure Java only, like the rest of the domain
 * layer (docs/architecture.md §3.1).
 */
