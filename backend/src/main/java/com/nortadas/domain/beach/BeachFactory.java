...
public final class BeachFactory {
    ...
    public static Beach create(Name name, Latitude latitude, Longitude longitude, Region region) {
    ...
    public static Beach rehydrate(
            BeachId beachId, Name name, Latitude latitude, Longitude longitude, Region region) {
        return new Beach(beachId, name, latitude, longitude, region);
    }
}
