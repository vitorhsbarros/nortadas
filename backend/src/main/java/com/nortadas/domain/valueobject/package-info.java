 ...
 * or local to a single one: {@code BeachId}, {@code RegionId},
 * {@code Latitude}, {@code Longitude}, {@code WindSpeed},
 ...
 *
 * <p>Aggregate root entities ({@code Beach}, {@code Region},
 * {@code FavouriteBeaches}) stay in their own aggregate packages and depend on
 * this package, never the other way round. Pure Java only, like the rest of the
 * domain layer (docs/architecture.md §3.1).
 */
